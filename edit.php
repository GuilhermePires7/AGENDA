    ...
    <div class="container">
        ...
        <form id="create-form" action="<?php echo $BASE_URL?>/config/process.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="phone" name="phone" placeholder="Digite seu telefone" value="<?php echo $contact["phone"]?>" required>
            </div>
            <div class="form-group">
                <label for="observations">Observações:</label>
                <textarea type="text" class="form-control" id="observations" name="observations"
                          placeholder="Insira suas observações" rows="3"><?php echo $contact["observations"]?></textarea>
            </div>
